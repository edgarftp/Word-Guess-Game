...
easy_mode = function (){
    ...
    document.onkeyup = function(event) {
        ...
        var wrongGuess = true;
        document.getElementById("lives").innerHTML = movies.j;
        
            if (((event.keyCode >= 48 && event.keyCode <=57) ||(event.keyCode >= 65 && event.keyCode <= 90)) && (movies.triedArray.indexOf(event.key)<0) && movies.j > 0) {
